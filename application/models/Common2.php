...
public function fetch_legacy_response($legacy_id,$parent_id,$user_id) { 
  ...
  //       }else{
  //     $this->email->from('ctinfotechindore@gmail.com', 'Grahuk App');         
  //       }
  //   $this->email->to($to);
  ...
  //////////////////////////////Notification///////////////////
    ...
    public function send_all_notification($user_id,$message,$type,$ref_type,$data=array()){
        ...
        if($ref_type == '3'){
            $ref_artist_id = $data['ref_artist_id'];
          }else{
            $ref_artist_id =  '0';
          }
          ...
          if($ref_type == '4'){
             ...
             $userdetail = user_detail($data['refer_id']);
        ...
        $msg_notification = array("body" =>$body,"title"=>$title,'type'=>$ref_type,'user_type'=>$user_type,'refer_id'=>$data['refer_id'],'ref_artist_id'=>$ref_artist_id); 
