          ...
          <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: center;">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0; text-align: center;">
               <div class="w-100"  style="font-family:Montserrat;text-align: center;width: 30%;color: #4DB02D;font-size: 45px;">
                 Legacy
              <!--   <img src="https://quickkitty.com/assets/quickkitty-web/logo.png" alt="" class="w-100" style="width: 30%;"> -->
               </div>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy" style="text-align:left;">
                ...
                <center><div align="center"></div> <p></p>

                <h2 style="text-align: left;margin-top:15px;"><strong> Your are one click away to reset your password </strong></h2>

                <p> <strong>Dear <?= $full_name; ?>,</strong>  </p>

                <p style="color:#333"> Please <a href="<?= base_url('home/resetPassword?token='.$token).'_'.$id; ?>">click here</a> to reset your password.</p>        
